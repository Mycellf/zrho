...
pub const KOLAKOSKI_SEQUENCE_LONG: &str = r"
    ...
    ; 200: 153327
    ; 250: 152284 (BEST)
    ; 500: 153148 (POINT OF INCREASE)
    ; 1000: 157092
    ; (THE BUFFER MAY BE COPIED TO H WITH ONE LESS THAN THE MAXIMUM)
    ; THE INCREASE IS LIKELY DUE TO DISCARDING THE PORTION OF THE LAST
    ; BUFFER THAT EXCEEDS THE CAPACITY OF H
    ...
    ADD I 1 I
    ADD M 1 M
    LJP I < 99 GENERATE ; JUMP IF THE BUFFER IS AT ITS SIZE LIMIT OR MIGHT
    ...
    ; ADD I TO Y WITHOUT OVERFLOWING
    LJP Y ≤ 9899 ADD_INDEX
    SUB 9999 Y Y
    JMP Y > I WITHIN_RANGE
    SET Y I
    LBL WITHIN_RANGE
    SUB 9999 Y Y
